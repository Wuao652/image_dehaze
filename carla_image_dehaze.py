...
if __name__ == "__main__":
    ...
    os.makedirs(f"/home/dennis/nerfplusplus/data/carla_data/hazy/9actors_trans", exist_ok=True)
    for i in range(len(img_files)):
        ...
        print(A)
        print(A[:, ::-1])
        np.savetxt(f"/home/dennis/nerfplusplus/data/carla_data/hazy/9actors_trans/a_{str(i).zfill(5)}.txt", A[:, ::-1])
        cv2.imwrite(f"/home/dennis/nerfplusplus/data/carla_data/hazy/9actors_trans/t_{str(i).zfill(5)}.png", coarse_t * 255.)
